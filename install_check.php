...
/*
 ...
 support@cryptonexum.com https://cryptonexum.com
 telegram @ctoninja
*/
...
<head>
    ...
    <title>cryptonexum Environment Check</title>
</head>
<body>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-12 mb-0 text-center">
            <h2 style="line-height: 60px;">cryptonexum Environment Check</h2>
        </div>
        <div class="col-sm-12">
            <ul class="list-group">
